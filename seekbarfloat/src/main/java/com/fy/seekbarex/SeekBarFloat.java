...
public class SeekBarFloat extends AppCompatSeekBar {
    ...
    private SeekBarFloat.OnSeekBarChangeListener mOnSeekBarChangeListenerEx;
     ...
     */
    public void setOnSeekBarChangeListener(SeekBarFloat.OnSeekBarChangeListener l) {
